...
const CartPage = () => {
  ...
  const [shipppingForm, setShippingForm] = useState({});
  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-between mt-12 px-16">
      {/* Title */}
          ...
          <CardContent className="flex flex-col gap-8">
            {activeStep === 1 ? (cartItems.map(item => (
              <div className="flex items-center justify-between" key={item.id}>
                ...
                <div className="w-[10%]">
                  <Button className="rounded-full bg-red-200 hover:bg-red-300" size={"icon"}>
